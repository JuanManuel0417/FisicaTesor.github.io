...
const acertijos = [
    ...
    { pregunta: ":¿A qué velocidad debe circular un auto de carreras para recorrer 113 km en un cuarto de hora?", respuestas: ["125,555 m/s"] },
    ...
    { pregunta: "Un sicario dispara una pistola de la cual sale una bala disparada a 573 m/s, y este mismo lleva un ángulo de elevación de 62° respecto a la horizontal. Calcula la ALTURA máxima que obtuvo la bala", respuestas: ["13513,687 m"] },

    { pregunta: "Un sicario dispara una pistola de la cual sale una bala disparada a 573 m/s, y este mismo lleva un ángulo de elevación de 62°, respecto a la horizontal. AHORA CALCULA EL ALCANCE.", respuestas: ["65179,399 m "] },
    ...
    { pregunta: " Un objeto realiza un movimiento circular uniforme acelerado y describe un diámetro de 0.8 m y efectúa una vuelta completa en 2.0 segundos. Calcula la velocidad Lineal", respuestas: ["12,566 m/s"] },
